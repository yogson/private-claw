...
Also search when:
- User mentioned something not in the current context, and the mention suggests you should know the related fact
- You need information about a user's environment, projects, prior decisions, or stated interests
